...
class DataLoader:
    ...
    # def batch_num(self):
    #     num = len(self.dataset)/self.batch_size
    ...
    #     else:
    #         self.size = num+1
    #         return [num,len(self.dataset)%self.batch_size]
    ...
    def __iter__(self):
        ...
        last = len(self.dataset)%self.batch_size
        length = int(len(self.dataset)/self.batch_size)
        i = 1
        ...
        for index in index_iterator:  # iterate over indices using the iterator
            ...
            # print(batch)
            if len(batch) == self.batch_size or (i == length and not self.drop_last):
                i +=1
                # print(batch)
                yield {'data':batch}  # use yield keyword to define a iterable generator
                batch = []
